    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="card p-8 w-full max-w-sm text-center">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">El Boletero</h1>
          <p className="text-gray-500 mt-1 text-sm">Tu sistema de boletas y cobros</p>
        </div>
        ...
        <p className="text-xs text-gray-400 mt-6">Acceso restringido · Solo usuarios autorizados</p>
      </div>
    </div>
  )
}
